...
const uint8_t PIN_LCD_RS = 15;
const uint8_t PIN_LCD_EN = 16;
const uint8_t PIN_LCD_D4 = 17;
const uint8_t PIN_LCD_D5 = 5;
const uint8_t PIN_LCD_D6 = 18;
const uint8_t PIN_LCD_D7 = 19;
...
void handleMenu() {
// Logika tombol disederhanakan (tanpa debouncing)
...
digitalWrite(RELAY_PIN, HIGH); // Relay OFF (standby)
delay(100);
...
tampilLCD("Loading Selesai", "ADS PlayStation");
delay(1000);
}
